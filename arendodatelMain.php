...
<head>
    ...
    <link rel="stylesheet" href="css/arendodatelMain.css">
...
<body>
    ...
    <div id="main">
        ...
        <div id="arendodatelMainBlock">
            ...
            <div class="accountSwiperBlock">

                <h5 class="accountSwiperMain">Мои объявления</h5>
                ...
                <div class="swiper-container">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="swiperSlideName darkGrey">Mercedes-Benz E, 2013 dbfdg gdf gdfg dfg gd</div>
                            ...
                            <div class="swiperSlideFeatures">
                                <div class="slideModify">
                                    <div class="pencilIcon"><img src="assets/all/pencil.svg"/></div>
                                    <div class="slideModifyText">Редактировать</div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="swiperSlideName darkGrey">Mercedeasdasd asdasd s-Benz E, 2013 dbfdg gdf gdfg dfg gd</div>
                            <div class="swiperSlidePrice darkGrey">2 000 ₽ <span class="priceDay lightGrey">/сутки</span></div>
                            <div class="swiperSlideFeatures">
                                <div class="slideModify">
                                    <div class="pencilIcon"><img src="assets/all/pencil.svg"/></div>
                ...
                <div class="submitButton">Добавить объявление</div>
            ...
            <div class="arendodatelFlexBlock">
                ...
                <div class="arendodatelFlexContent">
                    <div class="flexFiltrarionMarkersBlock">
                        <label class="container"><p>Все<span class="containerCountHint">10</span></p>

...
<head>
    ...
    <link rel="stylesheet" href="css/arendodatelDeal.css">
                    ...
                    <div class="bookingBlock bookingSubmit">
                        ...
                        <div class="notEndedDeal">
                            <div class="buttonsFlex">
                                <div class="submitButton acceptButton">Подтвердить</div>
                                <div class="submitButton denayButton">Отказать</div>
                            </div>

                            <div class="submitButton waitingForPaymentButton">Подтверждено</div>
                            <div class="submitButton processButton">Оплачено</div>
                            <div class="submitButton closingButton">Завершить сделку</div>

                            <div class="submitTextHint submitLongTextHint deniedSubmitHint">Арендатор отменил бронь</div>
                            <div class="submitTextHint waitingForPaymentSubmitHint">Ожидание оплаты</div>
                            <div class="submitTextHint processSubmitHint">Транспорт в процессе аренды</div>
                            <div class="submitTextHint closingSubmitHint">Время аренды истекло</div>
                        </div>

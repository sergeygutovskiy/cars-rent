            ...
            <div id="howItWorksContent">
                <div id="howItWorksContentFix">
                    ...
                    <div id="lineBlocks">
                        ...
                        <div id="forFour" class="tenantBlockText">Обсудить условия</div>
                        <div id="forFive" class="tenantBlockText">Заключить сделку</div>
                    </div>
                    ...
                    <div id="underLineBlocks">
                        <div id="tenant">
                            ...
                            <div class="tenantBlock">
                                <div class="tenantBlockText">Отправить заявку</div>
                                <div class="tenantBlockLogo">3</div>
                                
                            </div>
                            <div class="tenantBlock">
                                <div class="tenantBlockText">Выбрать авто</div>
                                <div class="tenantBlockLogo">2</div>
                                
                            </div>
                            <div class="tenantBlock">
                                <div class="tenantBlockText">Выбрать параметры</div>
                        ...
                        <div id="lessor">
                            <div id="lessorFirst">Собственник</div>
                            <div class="lessorBlock">
                                
                                <div class="lessorBlockLogo">3</div>
                                <div class="lessorBlockText">Получить заявку</div>
                            </div>
                            <div class="lessorBlock">
                                
                                <div class="lessorBlockLogo">2</div>
                                <div class="lessorBlockText">Установить условия</div>
                            </div>
                            <div class="lessorBlock">
                                
                                <div class="lessorBlockLogo">1</div>
                                <div class="lessorBlockText">Добавить авто в базу</div>
                            </div>
                        </div>
                    </div>
                </div>
